...
(function($) {
    ...
    Dirty.prototype = {
        ...
        /**          
         * Activar o no el comportamiento del plugin. Customizable para proyectos. Por defecto siempre estará activo
         * @param {Bool} isActive = Indicar si se desea que el plugin esté activo.
         */
