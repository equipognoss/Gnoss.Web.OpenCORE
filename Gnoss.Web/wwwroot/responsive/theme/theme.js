...
var tooltipComunidad = {
    ...
    config: function () {
        this.icono = $('.page-name-wrapper .comunidad');
        this.tooltip = $('.tooltip.comunidad');
    },
    lanzar: function () {
        var that = this;
    ...
    acciones: function () {
        ...
        this.tooltip.find('.col-datos .acceso').off('click').on('click', function () {
            if ($(this).hasClass("pedir-acceso")) {
                $(this).removeClass('btn-primary acceso').addClass('btn-link').text('Acceso solicitado');
            }
            $('.solicitar-acceso').find('.acceso').trigger('click');
        });
    }
};
...
var solicitarAccesoComunidad = {
    init: function () {
        ...
        solicitar.find('.cerrar').off('click').on('click', function () {
            $(this).parents('.solicitar-acceso').hide();
        });
