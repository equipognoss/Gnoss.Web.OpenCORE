...
var w_monthname=new Array("Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre");
//var w_dayname = new Array("Sun","Mon","Tue","Wed","Thu","Fri","Sat");
var w_dayname = new Array("Dom","Lun","Mar","Mier","Jue","Vier","Sab");
var w_StartOfWeek = 1; // Monday
// image title
//var prev_month_title = "Previous month";
//var next_month_title = "Next month";
//var close_title = "Close";
var prev_month_title = "Mes anterior";
var next_month_title = "Mes siguiente";
var close_title = "Cerrar";
...
function w_displayCal()
{
	...
	if(navigator.userAgent.indexOf("MSIE") != -1) 
	{
	    if (document.documentElement && !document.documentElement.scrollTop)
	    {
            ...
            weeklyCalendar.style.left= window.event.x+document.documentElement.scrollLeft;
		    weeklyCalendar.style.top= window.event.y+document.documentElement.scrollTop;
        }
    ...
    document.getElementById('weeklyCalendar').style.left = event.clientX + document.documentElement.scrollLeft + "px";
    document.getElementById('weeklyCalendar').style.top = (event.clientY + document.documentElement.scrollTop) + "px";
	} 
	...
	{
		document.getElementById('weeklyCalendar').style.left = gx + "px";
		document.getElementById('weeklyCalendar').style.top = gy + "px";
	}
...
function w_writeDayname()
{
    ...
    for(wd =0; wd < 7; wd++)
    {
		...
		if (w_dayname[mDay] == 'Sab')
            weekend_pos[0] = wd;
        //if (w_dayname[mDay] == 'Sun')
		if (w_dayname[mDay] == 'Dom')
            weekend_pos[1] = wd;

    }

    document.write('<td class="week" id="weekHeader">Sem</td>');
...
function buildWeeklyCalendar(WeekStart)
{
    ...
    document.write('<tr class="firstrow"><td width="8px" onClick="w_renderCalendar(-1);" align="right" ><img src="img/arrow_left.gif" title="' + prev_month_title + '" border="0"></td>');
    document.write('<td width="8px" onClick="w_renderCalendar(1);" align="left" ><img src="img/arrow_right.gif" title="' + next_month_title + '" border="0"></td>');
    ...
    document.write('<td align="center" onClick="w_hiddenCalendar()"><img src="img/close.jpg" title="' + close_title + '" border="0"></td>');
