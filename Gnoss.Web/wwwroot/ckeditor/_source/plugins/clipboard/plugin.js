	...
	CKEDITOR.plugins.add( 'clipboard',
		{
			...
			init : function( editor )
			{
				...
				editor.on( 'paste', function( evt )
					{
						//FERNANDO : Para que los enlaces que pegamos se abran en una ventana nueva
						var texto = '';
						if ( evt.data[ 'html' ] )
							texto =  evt.data[ 'html' ];
						...
						var expReg = [{busq:/target=\"[^\"]*\"/g, reemp:''}, {busq:/class=\"[^\"]*\"/g, reemp:''}, {busq:/id=\"[^\"]*\"/g, reemp:''}, {busq:/style=\"[^\"]*\"/g, reemp:''}];
						...
						editor.insertHtml(texto.replace(/<a /g, '<a target=\"_blank\" '));
