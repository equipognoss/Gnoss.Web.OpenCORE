...
(function() {
	...
	CKEDITOR.plugins.add( 'imagesimple', {
		requires: 'dialog',
		lang: 'en,es,pt', // %REMOVE_LINE_CORE%
		icons: 'imagesimple', // %REMOVE_LINE_CORE%
		hidpi: true, // %REMOVE_LINE_CORE%
		init: function( editor ) {
			var pluginName = 'imagesimple';

			// Register the dialog.
			CKEDITOR.dialog.add( pluginName, this.path + 'dialogs/imagesimple.js' );
			...
			editor.ui.addButton && editor.ui.addButton( 'Imagesimple', {
				label: editor.lang.common.image,
				command: pluginName,
				toolbar: 'insert,10',
				icon: this.path + "images/imagesimple.png"
			});
