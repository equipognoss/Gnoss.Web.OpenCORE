!(function () {
				...
				sections: [
					{
						...
						children: [
							...
							"bevelled-fraction",
							"small-fraction",
							"bevelled-small-fraction",
						],
					},
					{ id: "roots", children: ["root", "square-root", "cube-root"] },
					{
						...
						children: [
							...
							"left-subscript",
							"left-superscript",
							"left-superscript-subscript",
							"overscript-brace",
							"underscript-brace",
							"big-operator-subscript",
							"big-operator-subsuperscript",
							"big-operator-underoverscript",
							"big-operator-underscript",
						],
					},
					{
						id: "spaces",
				...
				sections: [
					{
						...
						children: [
							"integral",
							"integral-subscript",
							"integral-subscript-differential",
							"double-integral",
							"triple-integral",
							"contour-integral",
							"surface-integral",
							"volume-integral",
							"definite-integral",
							"definite-integral-differential",
						],
					},
					{
						id: "differentials",
					...
					{ id: "limits", children: ["limit-infinity", "limit-underscript"] },
					{
				...
				sections: [
					...
					},
					{
						...
						children: [
							...
							"product",
							"product-subscript",
							"product-subscript-superscript",
							"product-underoverscript",
							"product-underscript",
						],
					},
					{
				...
				sections: [
					...
					},
					{
						...
						children: [
							"three-column-row",
							"three-row-column",
							"two-column-row-parenthesis",
							"two-column-row-square-bracket",
							"two-row-column-left-curly-bracket",
							"two-row-column-parenthesis",
							"two-row-column-square-brackets",
				...
				sections: [
					...
					},
					{
						...
						children: [
							...
							"enclose-right",
							"enclose-double-left",
							"enclose-double-right",
							"enclose-box",
							"enclose-rounded-box",
							"enclose-actuarial",
							"vertical-strike",
							"horizontal-strike",
							"horizontal-vertical-strikes",
							"down-diagonal-strike",
							"up-diagonal-strike",
							"up-down-diagonal-strike",
							"enclose-circle",
						],
					},
				],
				...
				sections: [
					{
						...
						children: [
							...
							"downward-left-corner-arrow",
							"east-west-diagonal-arrow",
							"west-east-diagonal-arrow",
							"leftwards-arrow-from-bar",
							"leftwards-arrow-hook",
							"rightwards-arrow-from-bar",
							"rightwards-arrow-hook",
							...
							"upwards-arrow-left-downwards-arrow",
							"downwards-arrow-left-upwards-arrow",
							...
							"north-east-arrow",
							"north-west-arrow",
							"upwards-harpoon-left-downwards-harpoon",
							"downwards-harpoon-left-upwards-harpoon",
							"leftwards-harpoon-barb-downwards",
							"leftwards-harpoon-barb-upwards",
							"leftwards-harpoon-over-dash",
							"leftwards-harpoon-over-rightwards-harpoon",
							"rightwards-harpoon-barb-downwards",
							"rightwards-harpoon-below-dash",
							"rightwards-harpoon-over-leftwards-harpoon",
							"righwards-harpoon-barb-upwards",
						],
					},
					{
						id: "ellipsis",
					...
					},
					{
						id: "arrow-scripts",
						children: [
							"left-arrow-overscript",
							"left-arrow-underscript",
							"left-arrow-over-right-arrow-overscript",
							"left-arrow-over-right-arrow-underscript",
							"right-left-arrow-overscript",
							"right-left-arrow-underscript",
							"right-arrow-over-left-arrow-overscript",
							"right-arrow-over-left-arrow-underscript",
							"right-arrow-overscript",
							"right-arrow-subscript",
							"right-harpoon-over-left-harpoon-overscript",
							"right-harpoon-over-left-harpoon-underscript",
							"left-harpoon-over-right-harpoon-overscript",
							"left-harpoon-over-right-harpoon-underscript",
							"left-arrow-underoverscript",
							"left-arrow-over-right-arrow-underoverscript",
							"left-right-arrow-underoverscript",
							"right-arrow-over-left-arrow-underoverscript",
							"right-arrow-underoverscript",
							"right-harpoon-over-left-harpoon-underoverscript",
	...
	(function () {
		...
		(window.AreaPanel = function (e, t) {
			(this.visible = e.visible),
				...
				this.createSections(e.sections);
		}),
			...
			(AreaPanel.prototype = {
				createPanelArea: function () {
					let t = this,
						e =
							...
							(this.panelButtonArea.className =
								"fm-editor-panel-area-button-container"),
							(this.panelButtonArea.innerHTML =
								"<div class='fm-editor-panel-area-moveup-button'><div class='arrow-up'></div></div><div class='fm-editor-panel-area-movedown-button'><div class='arrow-down'></div></div><div class='fm-editor-panel-area-popup-button'><div class='left-down-arrow'></div></div>"),
							this.element.appendChild(this.panelButtonArea),
							this.panelButtonArea.getElementsByClassName(
				...
				createSections: function (t) {
					let e = document.createElement("div"),
						i =
							((e.className = "fm-editor-panel-area-section-container"),
							document.createElement("div")),
						m =
							((i.className = "fm-editor-panel-area-section-box"),
							(i.style.width = this.sectionWidth + "px"),
							e.appendChild(i),
							document.createElement("div")),
						a =
							((m.className = "fm-editor-panel-area-section-box-container"),
							i.appendChild(m),
							document.createElement("div"));
					(a.className = "fm-editor-panel-area-section-overlap-container"),
						m.appendChild(a);
					var o = new DropdownList(this);
					a.appendChild(o.element);
					for (let e = 0; e < t.length; e++) {
						var l = t[e];
						this.appendSection(l, a, o, 0 == e);
					}
					(this.sectionsMountPoint = document.createElement("div")),
						...
						this.sectionsMountPoint.appendChild(e),
						this.element.appendChild(this.sectionsMountPoint);
				},
				toggleSections: function (e) {
					return (
						null != this.sectionsMountPoint &&
							(this.active ? this.hideSections(e) : this.showSections(e)),
						e.stopPropagation(),
						!1
					);
				},
				showSections: function (e) {
					null != this.toolbar.activePanel &&
						this.toolbar.activePanel.hideSections(e),
						(this.sectionsMountPoint.style.display = "block"),
						(this.active = !0),
						DomUtils.addClass(this.element, "active"),
						(this.toolbar.activePanel = this);
				},
				hideSections: function (e) {
					(this.sectionsMountPoint.style.display = "none"),
						(this.active = !1),
						DomUtils.removeClass(this.element, "active"),
						(this.toolbar.activePanel = null);
				},
				appendSection: function (e, t, i, m) {
					e = new ButtonSection(e, this);
					0 < e.buttons.length &&
						(t.appendChild(e.element),
						this.sections.push(e),
						i.addListItem(e, m));
				},
				cloneButtonsToAreaBox: function (t) {
					this.panelAreaBox.innerHTML = "";
					let i = document.createElement("div");
					(i.className = "fm-editor-section-buttons"),
						this.panelAreaBox.appendChild(i);
				...
				scrollDownAreaBox: function () {
					...
					this.panelAreaBox.style.marginTop =
						Math.min(0, Math.max(56 - e + (e % 28), t - 56)) + "px";
				},
				getMarginTop: function () {
					let e = this.panelAreaBox.style.marginTop;
				...
				redraw: function () {
					(this.sections = []),
						...
						this.sectionsMountPoint.parentNode.removeChild(
							this.sectionsMountPoint
						),
						this.createPanelArea(),
	...
	(function () {
		"use strict";
		(window.Button = function (t, e) {
			(this.id = t),
				(this.element = document.createElement("span")),
				(this.element.className = "fm-editor-button math math-" + t),
				(this.element.id = this.id + "-btn"),
				(this.section = e),
				this.createEvent();
			t = this;
			this.element.addEventListener("click", function (e) {
				(t.addEquationEvent.clientX = e.clientX),
					(t.addEquationEvent.clientY = e.clientY),
					t.element.dispatchEvent(t.addEquationEvent);
			});
		}),
			...
			(Button.prototype = {
				createEvent: function () {
					(this.addEquationEvent = document.createEvent("Event")),
						...
						this.addEquationEvent.initEvent("addEquation", !0, !0);
				},
				element: null,
	...
	(function () {
		...
		(window.ButtonPanel = function (e, t) {
			...
			(ButtonPanel.prototype = {
				createPanelButton: function () {
					...
					let e = document.createElement("div"),
						t =
							...
							document.createElement("div")),
						i =
							((t.className = "fm-editor-panel-button-label"),
							(t.innerHTML = this.name),
							this.buttonElement.appendChild(e),
							this.buttonElement.appendChild(t),
				...
				createSections: function (t) {
					let i = document.createElement("div");
					(i.className = "fm-editor-section-container"),
						(i.style.width = this.sectionWidth + "px");
					for (let e = 0; e < t.length; e++) {
						var m = t[e];
						this.appendSection(m, i);
					}
					(this.sectionsMountPoint = document.createElement("div")),
						(this.sectionsMountPoint.className =
							"fm-editor-section-mount-point"),
						this.sectionsMountPoint.appendChild(i),
						this.element.appendChild(this.sectionsMountPoint);
				},
				toggleSections: function (e) {
					return (
				...
				showSections: function (e) {
					if (
						...
						(this.active = !0),
						DomUtils.addClass(this.element, "active"),
						this.buttonElement.getBoundingClientRect().left +
							this.sectionWidth >
							document.body.clientWidth)
					) {
						let e = -this.sectionWidth + this.buttonElement.clientWidth;
						e < -this.buttonElement.getBoundingClientRect().left &&
							(e = 20 - this.buttonElement.getBoundingClientRect().left),
							(this.sectionsMountPoint.style.left = e + "px");
					} else this.sectionsMountPoint.style.left = "-1px";
					this.toolbar.activePanel = this;
				},
				hideSections: function (e) {
					(this.active = !1),
				...
				appendSection: function (e, t) {
					e = new ButtonSection(e, this);
					0 < e.buttons.length &&
						(t.appendChild(e.element), this.sections.push(e));
				},
				redraw: function () {
					(this.sections = []),
						this.sectionsMountPoint.parentNode.removeChild(
	...
	(function () {
		...
		(window.ButtonSection = function (e, t) {
			(this.id = e.id),
				(this.name = e.name || trans[e.id] || e.id),
				(this.element = document.createElement("div")),
				...
				this.createTitle(),
				(this.buttons = []),
				e.children && 0 < e.children.length && this.createButtons(e.children);
		}),
			(ButtonSection.__name__ = ["ButtonSection"]),
			(ButtonSection.prototype = {
				createButtons: function (t) {
					let i = this.panel.toolbar.editor.actions;
					var m = this.panel.toolbar.editor.mlang;
					let a = document.createElement("div");
					a.className = "fm-editor-section-buttons";
					for (let e = 0; e < t.length; e++) {
						var o = t[e],
							l = i.get(o);
						l &&
				...
				createTitle: function () {
					let e = document.createElement("div");
					(e.className = "fm-editor-section-title"),
						(e.innerHTML = this.name),
						this.element.appendChild(e);
				},
				setActive: function () {
					this.active ||
						(DomUtils.addClass(this.element, "active"), (this.active = !0));
				},
				unsetActive: function () {
					this.active &&
						(DomUtils.removeClass(this.element, "active"), (this.active = !1));
				},
				element: null,
				active: !1,
				buttons: null,
		...
		(window.DropdownList = function (e) {
			(this.areaPanel = e),
				...
				(this.element.className =
					"fm-editor-dropdown fm-editor-dropdown-button"),
				(this.element.id = e.id + "-dropdown"),
				this.createLabel(),
				this.createList();
		}),
			...
			(DropdownList.prototype = {
				createLabel: function () {
					(this.labelButton = document.createElement("div")),
						...
						(this.labelButtonText.className =
							"fm-editor-dropdown-label-button-text"),
				...
				createList: function () {
					(this.listMountPoint = document.createElement("div")),
						(this.listMountPoint.className =
							"fm-editor-dropdown-list-mount-point");
					let e = document.createElement("div");
					(e.className = "fm-editor-dropdown-list-items"),
						(this.listItemContainer = document.createElement("div")),
						(this.listItemContainer.className =
							"fm-editor-dropdown-list-items-container"),
						e.appendChild(this.listItemContainer),
						this.listMountPoint.appendChild(e),
						this.element.appendChild(this.listMountPoint);
				},
				toggleList: function (e) {
					return (
						this.active ? this.hideList(e) : this.showList(e),
						e.stopPropagation(),
						!1
					);
				},
				...
				addListItem: function (e, t) {
					let i = new DropdownListItem(e, this);
					this.listItemContainer.appendChild(i.element), t && i.setActive();
				},
				changeActiveItem: function (e) {
					null !== this.activeItem && this.activeItem.unsetActive(),
						(this.activeItem = e),
						(this.labelButtonText.innerHTML = e.name),
	...
	(function () {
		...
		(window.Editor = function (e, t, i) {
			(this.lang = i.lang || this.lang),
				(this.lang = this.lang.replace(/_[a-zA-Z]+/g, "").toLocaleLowerCase()),
				(this.mlang = i.mlang || this.mlang),
				(this.initEquation = i.equation || this.initEquation),
				this.buildActionsHash(e),
				(this.panels = t);
			let m = this;
			DomUtils.loadJsFile(
			...
			(Editor.prototype = {
				init: function () {
					...
					let t = this;
					this.element.addEventListener("addEquation", function (e) {
						t.addEquation(e);
					}),
						document.addEventListener("click", function (e) {
							null != t.toolbar.activePanel &&
								t.toolbar.activePanel.hideSections(e),
								t.toolbar.mlangPanel.hideList(),
								(-1 == e.target.id.indexOf("btn") ||
									(-1 == e.target.id.indexOf("table") &&
										-1 == e.target.id.indexOf("matrix"))) &&
									t.hideMatrixPopup();
						}),
						null !== this.initEquation &&
							this.insertEquationToTextarea(
								decodeURIComponent(this.initEquation)
							);
				},
				createToolbar: function (e) {
					(this.toolbar = new Toolbar(e, this)),
						this.element.appendChild(this.toolbar.element);
				},
				addEquation: function (e) {
					var t = this.actions.get(e.formulaAction);
					let i = t[this.mlang];
					if (t.matrix)
						(this.currentMatrixEquation = i),
							this.showMatrixPopup(e.clientX, e.clientY);
					else {
						(t = /\{\{\$\}\}/g), (e = i.match(t));
						if (e && 0 < e.length)
							if (1 == e) i = i.replace(t, "x");
							else {
								let e = 1;
				...
				insertEquationToTextarea: function (e) {
					"latex" == this.mlang && (e += " "),
						this.textarea.insertAtCaret(e),
				...
				insertMatrixToTextarea: function () {
					...
					let m = this.currentMatrixEquation;
					if ((this.hideMatrixPopup(), null !== m && 0 < t && 0 < i)) {
						let e = "";
						(e =
							"latex" == this.mlang
								? this.createMatrixCodeLatex(t, i)
								: this.createMatrixCodeMml(t, i)),
							(m = (m = m.replace(/\{\{\$\}\}/g, e)).trim()),
							this.insertEquationToTextarea(m);
					}
				},
				createMatrixCodeLatex: function (e, i) {
					let m = "";
					for (let t = 0; t < e; t++) {
						for (let e = 0; e < i; e++)
							(m += " x_" + (e + 1 + t * i)),
				...
				createMatrixCodeMml: function (e, i) {
					let m = "";
					for (let t = 0; t < e; t++) {
						m += "<mtr>";
						for (let e = 0; e < i; e++)
				...
				renderEquationToResultarea: function (e) {
					"" !== (e = e || "").trim()
						? ((e =
								"latex" == this.mlang
									? "$$" + e.trim() + "$$"
				...
				createTextArea: function () {
					let e = document.createElement("div"),
						t =
							((e.className = "fm-editor-content-area"),
				...
				createResultArea: function () {
					let e = document.createElement("div"),
						t =
							...
							document.createElement("div"));
					(t.className = "fm-editor-result-area-label"),
						(t.innerHTML = trans.result || "result"),
						(this.resultarea = document.createElement("div")),
						(this.resultarea.className = "fm-editor-result-area-inner"),
						e.appendChild(t),
						e.appendChild(this.resultarea),
						this.element.appendChild(e);
				},
				createMatixActionPopup: function () {
					...
					let e = document.createElement("div"),
						t =
							((e.className = "fm-editor-matrix-popup-container"),
							(e.innerHTML =
								"<table><tr><td>" +
								(trans.rows || "rows") +
								":</td><td><input id=\"fm-editor-matrix-rows\" type='number' name='matrix-rows'/></td></tr><tr><td>" +
								(trans.columns || "columns") +
								":</td><td><input id=\"fm-editor-matrix-columns\" type='number' name='matrix-columns'/></td></tr><tr><td colspan='2'><button type='button' id='fm-editor-matrix-create-btn'>" +
								(trans.ok || "ok") +
								"</button></td></tr></table>"),
							this.matrixPopupMount.appendChild(e),
				...
				showMatrixPopup: function (e, t) {
					let i = document.getElementById("fm-editor-matrix-rows");
					(i.value = 2),
						(document.getElementById("fm-editor-matrix-columns").value = 2),
						DomUtils.addClass(this.matrixPopupMount, "active"),
						(this.matrixPopupMount.style.top = t - 40 + "px"),
						(this.matrixPopupMount.style.left = e - 20 + "px"),
						i.focus();
				},
				...
				getEquationPng: function (r) {
					let e = this.resultarea.getElementsByTagName("svg")[0];
					if (e) {
						e = e.cloneNode(!0);
						let o = this,
							l = (DomUtils.replaceSVGUseWithGraphElements(e), new Image());
						l.onload = function () {
							let e = document.createElement("canvas"),
								t =
									...
									(e.height = l.height * 2),
									e.getContext("2d"));
							t.drawImage(l, 0, 0, e.width, e.height);
							var i = e.toDataURL("image/png"),
								m = o.mlang,
								a = o.textarea.value.trim();
							r(i, m, a);
						};
						var t = new XMLSerializer().serializeToString(e);
						l.src = "data:image/svg+xml," + encodeURIComponent(t);
					} else r(null, null, null);
				},
			...
			(MlangPanel.prototype = {
				createPanelButton: function () {
					let e = document.createElement("div"),
						...
						i =
							...
							e.appendChild(t),
							e.appendChild(this.labelButtonText),
							this.element.appendChild(e),
							this);
					e.addEventListener("click", function (e) {
						return (
							i.enabled && i.toggleList(e),
							null != i.toolbar.activePanel &&
								i.toolbar.activePanel.hideSections(e),
							e.stopPropagation(),
							!1
						);
					});
				...
				createList: function () {
					...
					var t = new ButtonSection(
						{ id: "latex", name: "LaTeX", children: [] },
						this
					);
					let i = new DropdownListItem(t, this);
					this.listItemContainer.appendChild(i.element);
					t = new ButtonSection(
						{ id: "mml", name: "MathML", children: [] },
						this
					);
					let m = new DropdownListItem(t, this);
					this.listItemContainer.appendChild(m.element),
						("latex" == this.currentMlang ? i : m).setActive(),
						e.appendChild(this.listItemContainer),
						this.listMountPoint.appendChild(e),
						this.element.appendChild(this.listMountPoint);
				},
				...
				changeActiveItem: function (e) {
					null != this.activeItem &&
						(this.activeItem.unsetActive(),
						(this.toolbar.editor.mlang = e.id),
						this.toolbar.redraw()),
						(this.activeItem = e),
						(this.labelButtonText.innerHTML = e.name);
				},
				disable: function () {
					this.enabled &&
						((this.enabled = !1), DomUtils.addClass(this.element, "disabled"));
				},
				enable: function () {
					this.enabled ||
						((this.enabled = !0),
	...
	(function () {
		...
		(window.Toolbar = function (e, t) {
			...
			(Toolbar.prototype = {
				createPanels: function (t) {
					(this.panels = []), (this.activePanel = null);
					let i = document.createElement("div");
					(i.className = "fm-editor-panel-container"), this.createMlangPanel(i);
					for (let e = 0; e < t.length; e++) {
						var m = t[e];
						(m = new (m.visible ? AreaPanel : ButtonPanel)(m, this)),
							i.appendChild(m.element),
							this.panels.push(m);
					}
					this.element.appendChild(i);
				},
				createMlangPanel: function (e) {
					(this.mlangPanel = new MlangPanel(this)),
						e.appendChild(this.mlangPanel.element);
				},
				redraw: function () {
	...
	(function () {
		...
		(window.HashArray = function () {
			...
			(HashArray.prototype = {
				toString: function () {
					for (var e = "", t = ((e += "{"), this.keys()); t.hasNext(); ) {
						var i = t.next(),
							e = (e = e + i + " => ") + this.get(i);
						t.hasNext() && (e += ", ");
					}
				...
				keys: function () {
					var e,
						t = [];
					for (e in this.obj) this.obj.hasOwnProperty(e) && t.push(e.substr(1));
					return ArrayIterator(t);
				},
				remove: function (e) {
					return (
						!!this.obj.hasOwnProperty((e = "$" + e)) && (delete this.obj[e], !0)
					);
				},
				exists: function (e) {
	...
	(function () {
		...
		(window.DomUtils = {
			...
			replaceSVGUseWithGraphElements: function (e) {
				for (
					var t = e.getElementsByTagName("use"), i = [], m = [], a = 0;
					a < t.length;
					a++
				) {
					for (
						var o,
							l = t[a],
							r = l.getAttribute("href").replace("#", ""),
							n = document.getElementById(r).cloneNode(!0),
							s = ((n.id += "-c-" + new Date().getTime()), {}),
							d = 0;
						d < l.attributes.length;
						d++
					) {
						var c = l.attributes[d];
						"href" !== c.nodeName && "x" !== c.nodeName && "y" !== c.nodeName
							? n.setAttribute(c.nodeName, c.nodeValue)
							: ("x" != c.nodeName && "y" != c.nodeName) ||
							  (s[c.nodeName] = c.nodeValue);
					}
					s.x &&
						((r = (s.x || 0) + ", " + (s.y || 0)),
						"" !== (o = n.getAttribute("transform") || "") && (o += " "),
						(o += "translate(" + r + ")"),
				...
				for (a = 0; a < i.length; a++) {
					var u = m[a];
					(m[a] = a), u.parentNode.replaceChild(i[a], u);
				}
			},
		}),
			(HTMLTextAreaElement.prototype.insertAtCaret = function (e) {
				...
				(e = e || ""),
					document.selection
						? (this.focus(), (document.selection.createRange().text = e))
						: this.selectionStart || 0 === this.selectionStart
			...
			(HTMLTextAreaElement.prototype.getCaret = function () {
				...
				if (document.selection) {
					...
					var t = this.createTextRange(),
						i = t.duplicate();
					return (
						t.moveToBookmark(e.getBookmark()),
						i.setEndPoint("EndToStart", t),
						i.text.length
					);
				}
				return 0;
							...
							window.location.search.replace(
								...
								function (e, t, i) {
									(t = decodeURIComponent(t)),
										void 0 === m[t]
											? (m[t] = decodeURIComponent(i))
											: (m[t] = [].concat(m[t], decodeURIComponent(i)));
								}
							),
						m
					);
