...
namespace Es.Riam.Gnoss.Web.MVC.Controllers
{
    ...
    public class ComAdminElemSemanticosController : ControllerAdministrationWeb
    {
        ...
        private Ontologia ObtenerOntologia(Guid pOntologiaID)
        {
            ...
            {
                mMensajeAdmin = "Error al leer el XML de la ontología con ID " + pOntologiaID;
                mLoggingService.GuardarLogError(ex, mMensajeAdmin, mLogger);
                throw;
            }
            ...
            {
                mMensajeAdmin = "La ontología con ID " + pOntologiaID + " no es correcta";
                mLoggingService.GuardarLogError(ex, mMensajeAdmin, mLogger);
                throw;
            }
