...
{
	public class PermisosAdministracion : PermisosPaginasUsuariosAttribute
	{

		public PermisosAdministracion(ulong[] pPermisos, LoggingService loggingService, ConfigService configService, EntityContext entityContext, RedisCacheWrapper redisCacheWrapper, GnossCache gnossCache, VirtuosoAD virtuosoAD, IHttpContextAccessor httpContextAccessor, ILogger<PermisosAdministracion> logger, ILoggerFactory loggerFactory) : base(loggingService, configService, entityContext, redisCacheWrapper, gnossCache, virtuosoAD, httpContextAccessor, logger, loggerFactory, false)
		{
			...
			TipoDePermisoRequerido = TipoDePermiso.Comunidad;
